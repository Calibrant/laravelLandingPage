...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'pages'], function () {
        ...
        //admin/pages/add
        Route::match(['get', 'post'], 'add', ['uses'
        => 'PagesAddController@execute', 'as' => 'pagesAdd']);
        //admin/edit/2
    ...
    Route::group(['prefix' => 'portfolios'], function () {
        ...
        Route::match(['get', 'post'], 'add', ['uses'
        => 'PortfolioAddController@execute', 'as' => 'portfolioAdd']);
    ...
    Route::group(['prefix' => 'services'], function () {
        ...
        Route::match(['get', 'post'], 'add', ['uses'
        => 'ServiceAddController@execute', 'as' => 'serviceAdd']);
